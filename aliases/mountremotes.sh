...
umount ~/Remotes/tobias & mount_sshfs -o port=10022,reconnect,uid=501,gid=20,follow_symlinks,allow_other,IdentityFile=~/.ssh/id_rsa,volname="tobias" ~/Remotes/tobias root@mythli.net:/
